...
Drill files
-----------------
	- LimeNet-Micro_2v0.DRR -> Drill report detailing the tool assignments, hole sizes, hole count and tool travel. 
   
	- Throughole vias are covered in the following files:
   								File Name																	Start Layer						Stop Layer
						LimeNet-Micro_2v0-RoundHoles.TXT														Top								Bottom
    - Slotholes are covered in the following files:
						LimeNet-Micro_2v0-SlotHoles.TXT															Top								Bottom	
...
---------------
		...
		LimeNet-Micro_2v0.GTL				Top (Signal)
		LimeNet-Micro_2v0.G1				L2  (Signal)
		LimeNet-Micro_2v0.G2				L3  (Signal)
		LimeNet-Micro_2v0.G3				L4  (Signal)
		LimeNet-Micro_2v0.G4				L5  (Signal)
		LimeNet-Micro_2v0.GBL				Bottom (Signal)

		 
		LimeNet-Micro_2v0.GPB				Bottom Pad Master
		LimeNet-Micro_2v0.GPT				Top Pad Master

		LimeNet-Micro_2v0.GTO				Top Overlay
		LimeNet-Micro_2v0.GTP				Top Paste
		LimeNet-Micro_2v0.GTS				Top Solder

 
		LimeNet-Micro_2v0.GBS				Bottom Solder
		LimeNet-Micro_2v0.GBP				Bottom Paste
		LimeNet-Micro_2v0.GBO				Bottom Overlay


		LimeNet-Micro_2v0.GM1				Mechanical 1 (Board Cutout and dimensions)
		LimeNet-Micro_2v0.GM6				Notes (Board shape)
		

		LimeNet-Micro_2v0.GM14				ASM BOT (Assembly bottom)
		LimeNet-Micro_2v0.GM15				ASM TOP (Assembly top)
